...
最近有些朋友在面试阿里，加上 [Java-Interview](https://github.com/jsong/Java-Interview) 项目的原因也有小伙伴和我讨论，近期也在负责部门的招聘，这让我想起年初那段长达三个月的奇葩面试经历🤣。
...
之后又引申到[分布式锁](https://jsong.top/%2F2018%2F03%2F29%2Fdistributed-lock%2Fdistributed-lock-redis%2F)，光这块就聊了差不多半个小时。

之后又聊到了我的[开源项目](https://github.com/jsong)：
- 是如何想做这个项目的？
- 已经有一些关注了后续是如何规划的？
- 你今后的学习计划是什么？
- 平时看哪些书？
...
> 关于锁相关的内容可以参考这里：[ReentrantLock 实现原理](https://jsong.top/%2F2018%2F01%2F25%2FReentrantLock%2F) [synchronize 关键字原理](https://jsong.top/%2F2018%2F01%2F14%2FSynchronize%2F)
...
- [线程间通信的多种方式](https://jsong.top/%2F2018%2F03%2F16%2Fjava-senior%2Fthread-communication%2F)？
- 限流算法？单机限流？分布式限流？
- 提到了 Guava Cache ,了解它的[实现原理](https://jsong.top/2018/06/13/guava/guava-cache/)嘛？
- 如何定位一个线上问题？
- CPU 高负载？OOM 排查等？
...
- 谈谈对 Netty 的理解？
- Netty 的线程模型？
- [写一个 LRU 缓存](https://jsong.top/2018/04/07/algorithm/LRU-cache/)。
...
> [交替打印奇偶数](https://github.com/jsong/Java-Interview/blob/master/src/main/java/com/jsong/actual/TwoThread.java)
...
[一致性 Hash 算法的原理](https://jsong.top/2018/01/08/Consistent-Hash/)？
...
[volatile 关键字的原理及作用？happen Before？](https://jsong.top/2018/03/09/volatile/)
